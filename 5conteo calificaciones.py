...
print("Se ha calculado el promedio, la mediana, la desviación estándar, la máxima, la mínima calificación, y el conteo de calificaciones aprobatorias y reprobatorias por materia. Los resultados se han guardado en un nuevo archivo.")
