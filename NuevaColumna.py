...
#Esto es lo que hace este programa.
...
# En esta parte lee  el archivo Excel
archivo_excel = 'calificaciones_alumnos.xlsx'
df = pd.read_excel(archivo_excel, engine='openpyxl')

# En esta parte Generar valores aleatorios entre 0 y 100 con un decimal para la nueva columna 'Mat_Fisica'
...
print("Se ha agregado la columna 'Mat_Fisica' y guardado el archivo calificaciones_alumno_modificado.")